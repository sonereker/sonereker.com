...
(function (window, document) {
    ...
    function handleSubmit(event) {
        ...
        ExifReader.load(file, {async: true}).then(function (tags) {
            ...
            summary.innerHTML = ' <br />' + created.toLocaleString('en', options) + '' + tags['LensModel'].description + '<br />' + tags['FocalLengthIn35mmFilm'].description + 'mm • ƒ' + tags['FNumber'].description.replace('f/','') + ' • ISO' + tags['ISOSpeedRatings'].description;
            // <<<
